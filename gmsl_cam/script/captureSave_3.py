...
class Detection:
	...
	# self.cam0_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_19070800-video-index0"	 #right 90
        ...
        # Right cam        
        # self.cam0_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_23480200-video-index0"

        # self.cam0_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_1A080800-video-index0"
        # self.cam1_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_2B460000-video-index0"  #right 45
        
        # self.cam1_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_0F080800-video-index0"  #right 45
        # self.cam2_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_1A080800-video-index0"  #right 0
        ###################################################################################################
...
#                  zoom_absolute 0x009a090d (int)    : min=100 max=800 step=1 default=102 value=102
    ...
    def run(self):
        ...
        if self.save_img == 1:
            if ASUS:
                saving_folder   = "/home/usrg/Civil/img_test_3/"
            if STICK:
        ...
        image_pub1 = rospy.Publisher("image_frame5",        Image,  queue_size=1)
        image_pub2 = rospy.Publisher("image_frame6",        Image,  queue_size=1)
