...
class Detection:
    def __init__(self):
	    ...
	    # self.cam1_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_114F0B00-video-index0"  #left 0
...
#                  zoom_absolute 0x009a090d (int)    : min=100 max=800 step=1 default=102 value=102
    ...
    def run(self):
        ...
        if self.save_img == 1:
            if ASUS:
                saving_folder   = "/home/usrg/Civil/img_test_2/"
            if STICK:
        ...
        image_pub1 = rospy.Publisher("image_frame3",        Image,  queue_size=1)
        image_pub2 = rospy.Publisher("image_frame4",        Image,  queue_size=1)
