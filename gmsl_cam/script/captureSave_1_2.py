...
class Detection:
    def __init__(self):
        ...
        # self.cam1_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_1A480200-video-index0"	 #right 90
        ...
        self.cam0_addr = "/dev/v4l/by-id/usb-e-con_systems_NileCAM30_USB_32490400-video-index0"    #right 45 / 5 (board pos)
...
#                  zoom_absolute 0x009a090d (int)    : min=100 max=800 step=1 default=102 value=102
    ...
    def run(self):
        ...
        image_pub1 = rospy.Publisher("image_frame2",        Image,  queue_size=1)
