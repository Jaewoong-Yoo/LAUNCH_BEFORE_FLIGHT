...
int main(int argc, char** argv)
{
    ...
    init(argc, argv, "server_udp_node_usv");

    // assign node handler
    ros::NodeHandle nh;

    // for debugging
    printf("Initiate: server_udp_node_usv\n");

    // Publish Topic
    ros::Publisher FCC_Data_pub  = nh.advertise<fcc_serial::MsgStrRXttyO>("/USV/FCC", 1);
    ros::Publisher GPS_pub         = nh.advertise<std_msgs::Float32MultiArray> ("/USV/GPS"  ,1);

    // Subscribing the flight state

    // Get port number
    int UDP_PORTNUM;
    nh.getParam("udp_portnum_usv", UDP_PORTNUM);
...
//             printf("[TX_CH_8] \t %4.f \t[TX_CH_9] \t %4.f \t[TX_CH_13] \t %4.f \t[TX_CH_14] \t %4.f \t[TX_CH_15] \t %4.f \t[TX_CH_16] \t %4.f\n", RX_buff.FCC_Data.TX_CH_8_9_13_14_15_16_usec[0], RX_buff.FCC_Data.TX_CH_8_9_13_14_15_16_usec[1], RX_buff.FCC_Data.TX_CH_8_9_13_14_15_16_usec[2], RX_buff.FCC_Data.TX_CH_8_9_13_14_15_16_usec[3], RX_buff.FCC_Data.TX_CH_8_9_13_14_15_16_usec[4], RX_buff.FCC_Data.TX_CH_8_9_13_14_15_16_usec[5]);
    ...
    // for debugging
    printf("Terminate: comm_udp_node_usv\n");
    close(StrUDP.Socket);
